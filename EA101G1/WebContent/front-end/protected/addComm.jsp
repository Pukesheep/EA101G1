...
<table id="table-1">
	<tr>
		...
		<td>
			<h4><a href="<%=request.getContextPath()%>/front-end/index.jsp"><img alt="" src="<%=request.getContextPath()%>/images/tomcat.png" id="tomcat">回首頁</a></h4>
		</td>
	</tr>
</table>
...
<form action="comm.do" method="post" name="form1">
	...
	<table>
		...
		<tr>
			...
			<td>
				<%-- 
				<input type="text" name="mem_id" size="45" value="<%= (commVO == null) ? "" : commVO.getMem_id() %>">
				--%>
				<%=memberVO.getMem_id()%>
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="c_status">
					<option value="0" ${commVO ne null and commVO.c_status eq 0 ? "selected" : "" }>隱藏</option>
					<option value="1" ${commVO ne null or commVO.c_status ne 0 ? "selected" : "" }>顯示</option>
				</select>
			</td>
		</tr>
		<tr>

...
<table id="table-1">
	<tr>
		<td>
			...
			<h4><a href="<%=request.getContextPath()%>/back-end/member/select_page.jsp"><img src="<%=request.getContextPath()%>/images/back1.gif">回首頁</a></h4>
		</td>
	</tr>
</table>
		...
		<tr>
			...
			<td>
				<form action="<%=request.getContextPath()%>/member/member.do" method="post">
					...
					<input type="hidden" name="mem_id" value="${memberVO.mem_id}">
					<input type="hidden" name="action" value="delete-back">
				</form>
			</td>
		</tr>
	</c:forEach>
